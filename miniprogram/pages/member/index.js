const { getMember, getOrders } = require("../../utils/api")
...
Page({
  data: {
    ...
    orderCount: 0,
    benefitCards: [
      { title: "积分抵扣", desc: "300 积分可兑换 1 份炖汤。" },
      { title: "老客优惠券", desc: "下单后沉淀券包，推动下一次复购。" },
      { title: "连续下单奖励", desc: "连续消费可解锁额外兑换权益。" },
    ],
    rechargePlans: [
      { id: "plan-300", title: "充 300", desc: "送 3 张 88 折券", extra: "全单可用" },
  ...
  showPlanInfo(e) {
    ...
    wx.showModal({
      title: plan.title,
      content: `${plan.desc}，${plan.extra}。后续接入正式支付后可直接在这里完成充值。`,
      showCancel: false,
    })
  },
})
